// svg подключены не через тег img, для изменения их стилей
        ...
        <div className="hero__content">
          <div className="hero__content-item hero__content-item_first">
            <svg className="hero__content-icon" width="64" height="73" viewBox="0 0 64 73" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M60 39.5V25C60 11.7452 49.2548 1 36 1H28C14.7452 1 4 11.7452 4 25V39.5" stroke="#2E3A59" strokeWidth="2"/>
              <path d="M9 31C9 18.2975 19.2975 8 32 8C44.7025 8 55 18.2975 55 31V39C55 51.7025 44.7025 62 32 62C19.2975 62 9 51.7025 9 39V31Z" stroke="#2E3A59" strokeWidth="2"/>
              <path d="M29.5 70.5L36 70.5C49.2548 70.5 60 59.7548 60 46.5L60 36" stroke="#2E3A59" strokeWidth="2"/>
              <rect x="1" y="32" width="6" height="14" rx="3" stroke="#2E3A59" strokeWidth="2"/>
              <rect x="57" y="32" width="6" height="14" rx="3" stroke="#2E3A59" strokeWidth="2"/>
            </svg>
          ...
          <div className="hero__content-item hero__content-item_second">
            <svg className="hero__content-icon hero__content-icon_rotate" width="56" height="72" viewBox="0 0 56 72" fill="none" xmlns="http://www.w3.org/2000/svg">
              <circle cx="15.0001" cy="64" r="7" stroke="#2E3A59" strokeWidth="2"/>
              <rect x="25.0001" y="24" width="30" height="30" stroke="#2E3A59" strokeWidth="2"/>
              <rect x="37.0001" y="26" width="6" height="8" stroke="#00C368" strokeWidth="2"/>
            </svg>
            <p className="hero__content-text">Lorem ipsum, dolor sit amet consectetur adipisicing elit.</p>
          </div>
          ...
          <div className="hero__content-item hero__content-item_third">
            <svg className="hero__content-icon" width="57" height="72" viewBox="0 0 57 72" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="1.5" y="1" width="54" height="70" rx="3" stroke="#2E3A59" strokeWidth="2"/>
              <path d="M9.5 1H47.5V6C47.5 7.65685 46.1569 9 44.5 9H12.5C10.8431 9 9.5 7.65685 9.5 6V1Z" stroke="#2E3A59" strokeWidth="2"/>
              <path d="M9.5 57C9.5 55.3431 10.8431 54 12.5 54H44.5C46.1569 54 47.5 55.3431 47.5 57V59C47.5 60.6569 46.1569 62 44.5 62H12.5C10.8431 62 9.5 60.6569 9.5 59V57Z" stroke="#00C368" strokeWidth="2"/>
            </svg>
            <p className="hero__content-text">Lorem ipsum, dolor sit amet consectetur adipisicing elit.</p>
          </div>
